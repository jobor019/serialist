...
#ifndef SERIALISTLOOPER_NEW_GENERATOR_H
#define SERIALISTLOOPER_NEW_GENERATOR_H
...
template<typename T>
class NewGenerator : public Node<T>
                     , public ParameterHandler {
public:
    NewGenerator(const std::string& id
...
#endif //SERIALISTLOOPER_NEW_GENERATOR_H
