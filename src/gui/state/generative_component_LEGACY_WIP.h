...
#ifndef SERIALISTLOOPER_GENERATIVE_COMPONENT_LEGACY_WIP_H
#define SERIALISTLOOPER_GENERATIVE_COMPONENT_LEGACY_WIP_H
...
#endif //SERIALISTLOOPER_GENERATIVE_COMPONENT_LEGACY_WIP_H
