...
template<typename T>
ResultMatcher<T> sizet(std::size_t n, MatchType match_type = MatchType::last, bool allow_no_comparison = false) {
    return {c1m::sizet(n), "has size " + serialize(n), match_type, allow_no_comparison};
}


template<typename T>
ResultMatcher<T> containst(Trigger::Type type
...
template<typename T>
ResultMatcher<T> containst_off(std::optional<std::size_t> id = std::nullopt
                               , MatchType match_type = MatchType::last
                               , bool allow_no_comparison = false) {
...
template<typename T>
ResultMatcher<T> containst_on(std::optional<std::size_t> id = std::nullopt
                              , MatchType match_type = MatchType::last
                              , bool allow_no_comparison = false) {
...
template<typename T>
ResultMatcher<T> equalst(Trigger::Type type
                           , std::optional<std::size_t> id = std::nullopt
                           , MatchType match_type = MatchType::last
                           , bool allow_no_comparison = false) {
...
template<typename T>
ResultMatcher<T> equalst_off(std::optional<std::size_t> id = std::nullopt
                               , MatchType match_type = MatchType::last
                               , bool allow_no_comparison = false) {
...
template<typename T>
ResultMatcher<T> equalst_on(std::optional<std::size_t> id = std::nullopt
                              , MatchType match_type = MatchType::last
                              , bool allow_no_comparison = false) {
